...
create procedure sp_amenidades_create(
    ...
    in a_horario_uso varchar(30),
    in a_costo_uso decimal(12,2),
...
create procedure sp_Multas_create(
    in m_monto decimal(12,2), 
    in m_descripcion varchar(100), 
    in m_fecha_emision date, 
    in m_estado enum('pendiente', 'pagado', 'anulada'), 
    in m_tipo_persona ENUM('visita','residente')
)
begin 
    insert into Multas(monto, descripcion, fecha_emision, estado, tipo_persona)
    values (m_monto, m_descripcion, m_fecha_emision, m_estado, m_tipo_persona);
...
begin 
    insert into Pagos(id_residente, clasificacion_pago, monto, fecha_pago, metodo, referencia)
